...
So real reason the test failed is that you can't assert "toBeVisible" against multiple elements.
And the second lesson is that playwright errors provide an "error" field that you should check out before climbing up the stack trace.
