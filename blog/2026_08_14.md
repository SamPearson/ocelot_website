...
Nothing new, but I was able to visually confirm that the browser was opening and taking forever to resolve https://playwright.dev and actually load the page, so it was hitting the 30 second timeout honestly. At that point I started suspecting a resource constraint.
